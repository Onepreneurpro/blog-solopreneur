    ...
    <section className="py-20 px-4 bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 text-white border border-white/15 text-xs font-heading font-black uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          {/* BENTO CARD #1 (7 COLS) */}
          <div className="md:col-span-7 bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700/80 rounded-3xl p-8 flex flex-col justify-between group hover:border-[#ccff00]/50 transition-all duration-300 shadow-2xl relative overflow-hidden">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-2xl bg-purple-500/20 text-[#ccff00] border border-purple-400/30 flex items-center justify-center font-black text-xl">
          ...
          {/* BENTO CARD #2 (5 COLS) */}
          <div className="md:col-span-5 bg-gradient-to-br from-purple-950/80 to-slate-900 border border-purple-800/50 rounded-3xl p-8 flex flex-col justify-between group hover:border-purple-400 transition-all duration-300 shadow-2xl relative overflow-hidden">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-2xl bg-purple-500/20 text-purple-300 border border-purple-400/30 flex items-center justify-center font-black text-xl">
                  <Layers className="w-6 h-6" />
                </div>
                <span className="px-3 py-1 bg-purple-500/30 text-purple-200 border border-purple-400/40 rounded-full text-xs font-heading font-bold uppercase">
                  {card2Badge}
                </span>
              </div>
          ...
          <div className="md:col-span-12 bg-gradient-to-r from-slate-800 via-slate-900 to-indigo-950 border border-slate-700/80 rounded-3xl p-8 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8 group hover:border-indigo-400/50 transition-all duration-300 shadow-2xl">
            <div className="space-y-4 max-w-2xl">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-2xl bg-indigo-500/20 text-indigo-300 border border-indigo-400/30 flex items-center justify-center font-black text-xl">
                  <FileSpreadsheet className="w-6 h-6" />
                </div>
                <span className="px-3 py-1 bg-indigo-500/20 text-indigo-300 border border-indigo-400/30 rounded-full text-xs font-heading font-bold uppercase">
                  {card3Badge}
                </span>
              </div>
            ...
            <div className="flex-shrink-0">
              <Link href={card3Url}>
                <button className="px-8 py-4 rounded-full bg-[#ccff00] hover:bg-[#b8e600] text-slate-950 font-heading font-black text-sm transition-all hover:scale-105 shadow-xl">
                  {card3BtnText}
                </button>
              </Link>
            </div>
