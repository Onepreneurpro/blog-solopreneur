...
export const MAISON_TEMPLATES: MaisonTemplate[] = [
  // 0. TEMPLATE CLONE OFFICIAL: THE ARIZONA (COPYWRITER & BRAND VOICE)
  {
    ...
    elements: [
      {
        id: 'el-arizona-nav',
        type: 'BlockNavArizona',
        category: 'Blocs',
        content: 'Navigation Bar Teal Arizona',
        data: {
          links: ['HOME', 'ABOUT', 'SERVICES', 'BLOG', 'CONTACT', 'EXTRA'],
        },
      },
      {
        id: 'el-arizona-hero',
        type: 'BlockHeroArizona',
        category: 'Blocs',
        content: 'Your Brand Voice, Dressed in Technicolor',
        data: {
          tag: 'MARKETING SELLS WHEN',
          title: 'Your Brand Voice, Dressed in Technicolor',
          desc: 'Bold copy that demands attention, sparks connection, and converts — without ever toning it down.',
      ...
      {
        id: 'el-arizona-bio',
        type: 'BlockBioArizona',
        category: 'Blocs',
        content: 'Bio Claire Arizona',
        data: {
          title: "Hey, I'm Claire",
          subtitle: 'Welcome to the land of highlighter-worthy copy!',
          desc: 'The Painted Paragraph exists to help women take up more space—with words that radiate power, personality, and purpose. Because when your copy clicks, everything changes. Pudding jujubes gingerbread jujubes bamboo sweet powder. Candy canes icing danish shortbread chupa chups topping.',
          buttonText: 'GET STARTED NOW',
          img: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=600&q=80',
        },
      },
      {
        id: 'el-arizona-sisters',
        type: 'BlockSoulSistersArizona',
        category: 'Blocs',
        content: 'Soul Sisters Arizona',
        data: {
      ...
      {
        id: 'el-arizona-arcade',
        type: 'Block3ColArcadeArizona',
        category: 'Blocs',
        ...
        data: {
          ...
          items: [
            ...
            },
            {
              ...
              theme: 'mint',
              img: 'https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?auto=format&fit=crop&w=500&q=80',
              desc: 'Toffee bonbon gummy bears jujubes pudding cheesecake. Pudding jujubes gingerbread jujubes bonbon sweet powder.',
            },
            {
              id: '3',
