                  ...
                  <div className="space-y-3 pt-3 border-t border-slate-800">
                    ...
                    <div className="pt-4 border-t border-slate-800 space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-2 pt-0.5">
                        ...
                        <button
                          type="button"
                          title={(targetData.showDesktop !== undefined ? targetData.showDesktop : true) ? 'Affichage actuellement ACTIVÉ sur PC (cliquez pour Désactiver)' : 'Affichage actuellement DÉSACTIVÉ sur PC (cliquez pour Activer)'}
                          onClick={() => {
                        ...
                        <button
                          type="button"
                          title={(targetData.showMobile !== undefined ? targetData.showMobile : true) ? 'Affichage actuellement ACTIVÉ sur Mobile (cliquez pour Désactiver)' : 'Affichage actuellement DÉSACTIVÉ sur Mobile (cliquez pour Activer)'}
                          onClick={() => {
