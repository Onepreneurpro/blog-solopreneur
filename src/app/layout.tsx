  ...
  return (
    <html lang="fr" className={`h-full ${poppins.variable} ${archivoBlack.variable} ${bebasNeue.variable}`}>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Caveat:wght@400;700&family=Cinzel:wght@400;700;900&family=Inter:wght@400;600;800;900&family=Lora:ital,wght@0,400;0,700;1,400&family=Montserrat:wght@400;700;900&family=Oswald:wght@400;600;700&family=Playfair+Display:ital,wght@0,400;0,700;0,900;1,400&family=Plus+Jakarta+Sans:wght@400;700;800&family=Poppins:wght@400;600;800;900&family=Raleway:wght@400;700;900&family=Roboto:wght@400;700;900&display=swap"
          rel="stylesheet"
        />
      </head>
